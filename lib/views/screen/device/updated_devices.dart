          ...
          children: [
             ...
             :ListView.builder(
                ...
                GestureDetector(
                  ...
                  onLongPress: (){
                    showDialog(context: context, builder: (BuildContext buildContext){
                          return  AlertDialog(
                            title: const Text("Voulez vous supprimer cet appareil ?",style: TextStyle(color: Colors.red),),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      onPressed: () async{
                                        var request = await deviceProvider.deleteDevice(Provider.of<CapteurProvider>(context,listen:false).getNamedCapteurs()[index].id);
              ...
              //separatorBuilder: (_,index)=>SizedBox(width: 20)
                ...
                shrinkWrap: true,
                scrollDirection: Axis.vertical,
                itemCount: capteurProvider.namedCapteurs.length,
                itemBuilder: (context,index)=>GestureDetector(
                            ...
                            child: DropdownButton<String>(
                                  ...
                                  items: List.generate(roomProvider.room["result"].length, (index) => DropdownMenuItem<String>(
                                    ...
                                    setState(() {
                                      ...
                                      Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].nameRoom =  valSelectionneP!;
                                    });
                                  }),
                              ),
                              Row(
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: (){
                                    setState(() {
                                        if(Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].state[0]==0){
                                          Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].state[0]=1;
                                          Map<String,dynamic> msg = {
                                            "id":"${Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].id}",
                                            "state":Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].state
                                          };
                                          allumerEteindre(jsonEncode(msg));
                                        }
                                        else{
                                          Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].state[0]=0;
                                          Map<String,dynamic> msg = {
                                            "id":"${Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].id}",
                                            "state":Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index].state
                                          };
                                  ...
                                  Padding(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      if(_formKey.currentState!.validate()){
                                        dynamic req =  await capteurProvider.addCapteur(Provider.of<CapteurProvider>(context,listen:false).namedCapteurs[index]);
                  ...
                  child:Text(
                    'Capteur '+'${Provider.of<CapteurProvider>(context,listen:false).capteur![index].nameRoom}',
